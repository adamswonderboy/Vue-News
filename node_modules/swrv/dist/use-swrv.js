...
function useSWRV() {
    ...
    var instance = composition_api_1.getCurrentInstance();
    ...
    var isSsrHydration = Boolean(!IS_SERVER &&
        vm.$vnode &&
        vm.$vnode.elm &&
    ...
    var keyRef = typeof key === 'function' ? key : composition_api_1.ref(key);
    ...
    if (isSsrHydration) {
        ...
        var swrvState = window.__SWRV_STATE__ ||
            (window.__NUXT__ && window.__NUXT__.swrv) || [];
        var swrvKey = +vm.$vnode.elm.dataset.swrvKey;
        if (swrvKey !== undefined && swrvKey !== null) {
            var nodeState = swrvState[swrvKey] || [];
            var instanceState = nodeState[composition_api_1.isRef(keyRef) ? keyRef.value : keyRef()];
            if (instanceState) {
                stateRef = composition_api_1.reactive(instanceState);
                isHydrated = true;
            }
        }
    }
    if (!stateRef) {
        stateRef = composition_api_1.reactive({
            data: undefined,
            error: undefined,
            isValidating: true,
            key: null
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                        ...
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                    ...
                                    newPromise = fetcher.apply(void 0, __spread(fetcherArgs));
                    ...
                    if (!(newData && config.revalidateDebounce)) return [3 /*break*/, 2];
    ...
    if (IS_SERVER) {
        ...
        var swrvRes_1 = [];
        if (vm.$ssrContext) {
            swrvRes_1 = vm.$ssrContext.swrv = vm.$ssrContext.swrv || swrvRes_1;
        }
        var ssrKey_1 = swrvRes_1.length;
        if (!vm.$vnode || (vm.$node && !vm.$node.data)) {
            vm.$vnode = {
                data: { attrs: { 'data-swrv-key': ssrKey_1 } }
            };
        }
        var attrs = (vm.$vnode.data.attrs = vm.$vnode.data.attrs || {});
        attrs['data-swrv-key'] = ssrKey_1;
        // Nuxt compatibility
        if (vm.$ssrContext && vm.$ssrContext.nuxt) {
            vm.$ssrContext.nuxt.swrv = swrvRes_1;
        }
        composition_api_1.onServerPrefetch(function () { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, revalidate()];
                    case 1:
                        _a.sent();
                        if (!swrvRes_1[ssrKey_1])
                            swrvRes_1[ssrKey_1] = {};
                        swrvRes_1[ssrKey_1][keyRef.value] = {
                            data: stateRef.data,
     ...
     */
    try {
        composition_api_1.watch(keyRef, function (val) {
            keyRef.value = val;
            stateRef.key = val;
    ...
    var res = __assign(__assign({}, composition_api_1.toRefs(stateRef)), { mutate: function (data, opts) { return revalidate(data, __assign(__assign({}, opts), { forceRevalidate: true })); } });
    return res;
}
